...
export const AVAILABLE_LLM_PROVIDERS = [
  {
    ...
    requiredConfig: ["GenericOpenAiKey"],
...
export default function GeneralLLMPreference() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const form = e.target;
    const selectedProvider = AVAILABLE_LLM_PROVIDERS.find(
      (llm) => llm.value === selectedLLM
    );
    const backendProvider = selectedProvider?.backendValue ?? selectedLLM;
    const data = { LLMProvider: backendProvider };
  ...
  useEffect(() => {
    async function fetchKeys() {
      ...
      let provider = _settings?.LLMProvider || "generic-openai";
      if (provider === "generic-openai" && _settings?.GenericOpenAiBasePath) {
        ...
        (!_settings?.GenericOpenAiBasePath ||
            ...
            <div className="flex flex-col w-full px-1 md:pl-6 md:pr-[50px] md:py-6 py-16">
              <div className="w-full flex flex-col gap-y-1 pb-6 border-white border-b-2 border-opacity-10">
                <div className="flex gap-x-4 items-center">
                  <p className="text-lg leading-6 font-bold text-theme-text">
                    LLM Preference
                  </p>
                </div>
                <p className="text-xs leading-[18px] font-base text-theme-text-muted">
              ...
              <div className="text-base font-bold text-theme-text mt-6 mb-4">
                LLM Provider
              </div>
              <div className="relative">
                ...
                {searchMenuOpen ? (
                  <div className="absolute top-0 left-0 w-full max-w-[640px] max-h-[310px] overflow-auto white-scrollbar min-h-[64px] bg-dropdown-bg rounded-lg flex flex-col justify-between cursor-pointer border-2 border-dropdown-border z-20">
                    <div className="w-full flex flex-col gap-y-1">
                      <div className="flex items-center sticky top-0 border-b border-dropdown-border mx-4 bg-dropdown-bg">
                        <MagnifyingGlass
                          size={20}
                          weight="bold"
                        ...
                        <input
                          ...
                          className="-ml-4 my-2 bg-transparent z-20 pl-12 h-[38px] w-full px-4 py-1 text-sm outline-none focus:border-dropdown-border text-theme-text placeholder:text-theme-text-muted placeholder:font-medium"
                  ...
                  <button
                    className="w-full max-w-[640px] h-[64px] bg-dropdown-bg rounded-lg flex items-center p-[14px] justify-between cursor-pointer border-2 border-transparent hover:border-dropdown-border transition-all duration-300"
                    type="button"
