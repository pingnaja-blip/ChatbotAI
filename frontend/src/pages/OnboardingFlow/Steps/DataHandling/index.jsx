...
export const LLM_SELECTION_PRIVACY = {
  ...
  deepseek: {
    ...
    description: [
      "Your chats will not be used for training",
      "Your prompts and document text are sent to DeepSeek's API for processing",
    ],
  ...
  return (
    <div className="w-full flex items-center justify-center flex-col gap-y-6">
      <div className="p-8 flex flex-col gap-8">
        <div className="flex flex-col gap-y-2 border-b border-outline/50 pb-4">
          <div className="text-theme-text text-base font-bold">LLM Selection</div>
          <div className="flex items-center gap-2.5">
            ...
            />
            <p className="text-theme-text text-sm font-bold">
              {LLM_SELECTION_PRIVACY[llmChoice].name}
            </p>
          </div>
          <ul className="flex flex-col list-disc ml-4">
            {LLM_SELECTION_PRIVACY[llmChoice].description.map((desc) => (
              <li className="text-theme-text-muted text-sm">{desc}</li>
            ))}
          </ul>
        </div>
        <div className="flex flex-col gap-y-2 border-b border-outline/50 pb-4">
          <div className="text-theme-text text-base font-bold">
        ...
        <div className="flex flex-col gap-y-2 pb-4">
          <div className="text-theme-text text-base font-bold">Vector Database</div>
          <div className="flex items-center gap-2.5">
            <img
      ...
      <p className="text-theme-text-muted text-sm font-medium py-1">
