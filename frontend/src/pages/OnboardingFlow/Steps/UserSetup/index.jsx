...
export default function UserSetup({ setHeader, setForwardBtn, setBackBtn }) {
  ...
  return (
    <div className="w-full flex items-center justify-center flex-col gap-y-6">
      <div className="flex flex-col border-2 rounded-xl border-outline bg-white/60 shadow-lg backdrop-blur-sm p-8 items-center gap-y-4 w-full max-w-[600px]">
        <div className="text-theme-text text-sm font-semibold md:-ml-44">
          ...
          <button
            ...
            className={`${
              selectedOption === "just_me"
                ? "text-theme-text border-outline bg-accent/20 shadow-md"
                : "text-theme-text-muted border-outline/70 bg-white/50"
            } min-w-[230px] h-11 p-4 rounded-xl border-2 justify-center items-center gap-[100px] inline-flex hover:border-outline hover:text-theme-text hover:bg-accent/10 transition-all duration-300`}
          >
...
const JustMe = ({
  ...
  return (
    <div className="w-full flex items-center justify-center flex-col gap-y-6">
      <div className="flex flex-col border-2 rounded-xl border-outline bg-white/60 shadow-lg backdrop-blur-sm p-8 items-center gap-y-4 w-full max-w-[600px]">
        <div className="text-theme-text text-sm font-semibold md:-ml-56">
        ...
        {enablePassword && (
          <form className="w-full mt-4" onSubmit={handleSubmit}>
            ...
            <input
              name="password"
              type="password"
              className="bg-dropdown-bg text-theme-text border border-outline text-sm rounded-lg block w-full p-2.5 placeholder:text-theme-text-muted focus:ring-2 focus:ring-outline focus:border-outline"
            ...
            />
            <div className="mt-4 text-theme-text-muted text-xs font-base -mb-2">
...
const MyTeam = ({ setMultiUserLoginValid, myTeamSubmitRef, navigate }) => {
  ...
  return (
    <div className="w-full flex items-center justify-center border-2 max-w-[600px] rounded-xl border-outline bg-white/60 shadow-lg backdrop-blur-sm">
      <form onSubmit={handleSubmit}>
        <div className="flex flex-col w-full md:px-8 px-2 py-4">
          <div className="space-y-6 flex h-full w-full">
            <div className="w-full flex flex-col gap-y-4">
              ...
              <p className="w-96 text-theme-text-muted text-xs font-base">
        ...
        <div className="flex w-full justify-between items-center px-6 py-4 space-x-6 border-t rounded-b border-outline/50">
          <div className="text-theme-text-muted text-xs font-base">
