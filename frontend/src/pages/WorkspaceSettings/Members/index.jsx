  ...
  return (
    <div className="flex justify-between -mt-3">
      <table className="w-full max-w-[700px] text-sm text-left rounded-lg">
        <thead className="text-theme-text text-xs leading-[18px] font-bold uppercase border-outline border-b">
          <tr>
        ...
        <tbody>
          {workspaceUsers.length > 0 ? (
            ...
            <tr>
              <td className="text-center py-4 text-theme-text-muted" colSpan="4">
