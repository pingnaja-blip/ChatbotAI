...
export default function SettingsSidebar() {
  ...
  if (isMobile) {
    return (
      <>
        <div className="fixed top-0 left-0 right-0 z-10 flex justify-between items-center px-4 py-2 bg-sidebar text-theme-text shadow-lg h-16">
          <button
          ...
          >
            <div className="w-full h-full flex flex-col overflow-x-hidden items-between">
              ...
              <div className="flex w-full items-center justify-between gap-x-4">
                ...
                <div className="flex gap-x-2 items-center text-theme-text-muted shrink-0">
                  <a
                    href={paths.home()}
    ...
    <div>
      ...
      >
        <div className="w-full h-full flex flex-col overflow-x-hidden items-between min-w-[235px]">
          <div className="text-theme-text-muted text-sm font-medium uppercase mt-[4px] mb-0 ml-2">
            Instance Settings
          </div>
    ...
    <>
      <div className="flex gap-x-2 items-center justify-between">
        <Link
          ...
          hover:bg-workspace-item-selected-gradient hover:text-theme-text hover:font-medium
          ${
            isActive
              ? "bg-menu-item-selected-gradient font-medium border-outline text-theme-text"
              : "hover:bg-menu-item-selected-gradient text-theme-text-muted"
          }
        `}
        >
